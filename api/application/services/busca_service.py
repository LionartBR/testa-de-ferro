# api/application/services/busca_service.py
...
class BuscaService:
    ...
    def buscar(self, query: str, limit: int) -> list[FornecedorResumoDTO]:
        fornecedores = self._fornecedor_repo.buscar_por_nome_ou_cnpj(query, limit)
        return [
            FornecedorResumoDTO(
